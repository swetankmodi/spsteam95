    ...
    <div class="container formCard">
      ...
      <form action="/task/create" method="POST" id="taskCreateForm">
        ...
        <div class="form-group row">
          ...
          <div class="col">
            <textarea class="form-control" rows="6" name="details" id="detailsInput" placeholder="1 Kg Potatoes, 1L Vegetable Oil" autocomplete="off" required></textarea>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col">
            <input class='form-control' type="datetime-local" name="deadline" id="deadlineInput" placeholder="500" autocomplete="off">
          </div>
        </div>
